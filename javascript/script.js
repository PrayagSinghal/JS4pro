...
function queMainfun() {
    ...
    let queFun1 = () => {
        queBackground.style.background = "linear-gradient(45deg, rgba(87, 58, 250, 0.5) 0%, rgba(90, 58, 250, 0.5)100%),  url(../Images/portfolio-7-min.jpg) center center no-repeat"
    };

    setTimeout(queFun1, 2000);
    let queFun2 = () => {
        queBackground.style.background = "linear-gradient(45deg, rgba(87, 58, 250, 0.5) 0%, rgba(90, 58, 250, 0.5)100%), url(../Images/portfolio-8-min.jpg) center center no-repeat"
    };
    setTimeout(queFun2, 3000);

    let queFun3 = () => {
        queBackground.style.background = "linear-gradient(45deg, rgba(87, 58, 250, 0.5) 0%, rgba(90, 58, 250, 0.5)100%), url(../Images/portfolio-2-min.jpg) center center no-repeat"
    };
...
changerBtn.addEventListener('click', () => {
    ...
    box6ServiceP2.style.background = " linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    box6ServiceP2.style.color = "white";
    box1ServiceP2.style.background = " linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    box1ServiceP2.style.color = "white";
    box2ServiceP2.style.background = " linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    box2ServiceP2.style.color = "white";
    box3ServiceP2.style.background = " linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    box3ServiceP2.style.color = "white";
    box4ServiceP2.style.background = " linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    box4ServiceP2.style.color = "white";
    box5ServiceP2.style.background = " linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    ...
    paratestimonial1.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    paratestimonial2.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    paratestimonial3.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    ...
    btn4portfolioP1.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    btn4portfolioP1.style.color = "white";
    btn3portfolioP1.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    btn3portfolioP1.style.color = "white";
    btn2portfolioP1.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    btn2portfolioP1.style.color = "white";
    btn1portfolioP1.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
    ...
    call.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";

    email.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";

    address.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";

    form.style.background = "linear-gradient(45deg, rgba(116, 15, 214, 0.9)30%, rgba(86, 58, 250, 0.9)70%)";
